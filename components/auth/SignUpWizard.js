        ...
        <div className="text-center">
          <div className="mx-auto h-12 w-12 sm:h-16 sm:w-16 mb-3 sm:mb-4 relative">
            ...
            <div className="absolute inset-2 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center shadow-modern">
              <span className="text-xl sm:text-2xl">{currentStep === 1 ? '👤' : '🌍'}</span>
            </div>
          </div>
          <CardTitle className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 dark:from-slate-200 dark:to-slate-400 bg-clip-text text-transparent">
            ...
            <>
              <div className="space-y-2 sm:space-y-3">
                ...
                <Select value={formData.nativeLanguage} onValueChange={handleLanguageChange}>
                  <SelectTrigger className="input-modern h-12 sm:h-auto text-base sm:text-sm">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-3 sm:gap-0 pt-4 sm:pt-6">
            {currentStep > 1 && (
              <Button 
                ...
                variant="outline" 
                onClick={prevStep}
                className="px-4 sm:px-6 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition-all duration-300 h-12 sm:h-auto text-base sm:text-sm"
              >
            ...
            {currentStep < 2 ? (
              <Button 
                ...
                className="w-full sm:w-auto sm:ml-auto btn-modern h-12 sm:h-auto text-base sm:text-sm"
              >
                Next
